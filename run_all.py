...
#         # if api_name in ["Adobe Audience Manager", "Amazon AWS Core IoT", "Apple App Store Connect", "Arduino IoT Cloud", "Bitholic", "BroadCom", "Cisco Flare", "ClearBlade", "Coursera", "Dropbox", "Google Nest", "GroupWise", "Guardian", "IBM Watson IoT", "IBM Cloud Pak System", "Linkedin", "LiveAgent", "Losant"]:
#         #    continue
#         if api_name in ["AniList", "AppleMusic", "Artsy", "Braintree", "Facebook", "GitHub", "GitLab", "Instagram", "Pipefy", "Pokeapi",  "Shopify", "Twitter", "Intuit", "Pinterest", "Hygraph", "Netflix", "Yelp Fusion"]:
#             continue
